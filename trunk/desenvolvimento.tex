...
\begin{itemize}
  \item Associar os requisitos de acessibilidade e os modelos \gls{uml};
  \item Visualizar e gerenciar as associações descritas anteriormente;
  \item Vincular as técnicas de implementação para os elementos associados anteriormente;
  \item Gerar a matriz de rastreabilidade dos elementos associados;
  \item Recuperar as informações de rastreabilidade entre as fases de engenharia de requisitos e codificação. 
\end{itemize}
