...
diretamente na acessibilidade do produto final. O artefato XML/XMI gerado pela ferramenta \gls{case},
ainda sem acessibilidade, obtido no Subprocesso anterior passará por cada tarefa deste Subprocesso, de forma que,
...
\caption{Seleção da ontologia \textit{WCAG 2.0 SuccessCriterion 1.2.7}}
