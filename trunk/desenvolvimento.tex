...
\textbf{FIGURA ERRO NO QUADRADO ANALYSIS AND DESIGN E INCLUIR ATORES USUARIO FINAL}

\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{./images/developmentNew.png}
...
\textbf{AUMENTAR FIGURAS}

\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{./images/protege.png}
...
A recuperação dos comentários personalizados encerra a proposta deste trabalho. Os passos aqui descritos descrevem a construção da ferramenta, seguindo a abordagem da Figura \ref{fig:figuramagica} e detalhada na Figura \ref{fig:developmentNew}. O próximo capítulo apresentará uma prova de conceito, que utilizará o \gls{mta} e os \textit{plugins} e ferramentas aqui elencados para demonstrar a
