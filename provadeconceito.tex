...
\textbf{As Taferas (Estabelecer os Requisitos de Acessibilidade do Software) e
(Avaliar os Requisitos de Acessibilidade do Software) especifica,, avaliam
e documentam os requisitos de sistema em requisitos de \textit{software}.
Todos os requisitos, tanto os funcionais (RF) como os não-funcionais (RNF), inclusive os de acessibilidade (RA), podem ser vistos abaixo: REVISAR}

\textbf{NUMERAR DE ACORDO COM A FIGURA}
...
\begin{itemize}
  ...
  \item o sistema deve seguir a recomendação de
  ...
  via teclado (RF e RA);
  \item o sistema deve permitir que o tempo para ler e utilizar o conteúdo seja
  suficiente (RNF e RA);
  \item o sistema deve entregar um conteúdo que não cause convulsão (RNF e RA) \textbf{OLHAR DIREITO};
