...
\begin{figure}[htbp]
\centering
\includegraphics[width=.8\textwidth]{./images/reqtec.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=.8\textwidth]{./images/modeltec.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=.8\textwidth]{./images/generatedcode.png}
...
notar que as ontologias utilizadas incluem elementos de testes que podem ser
associados como técnicas de
acessibilidade\footnote{http://www.w3.org/TR/WCAG20-TECHS/} que podem ser
...
se as informações apresentadas pela ferramenta eram suficientes ou
desnecessárias. Não foi possível dizer se os mapeamentos encontrados nas
ontologias utilizadas eram suficientes para fornecer informações úteis aos
projetistas/desenvolvedores. Este não é um problema tão sério, já que as
ontologias podem ser modificadas/aprimoradas utilizando a ferramenta
\textit{Protegé}, devendo o \textit{plugin AccTrace} ser alterado para que
comporte a nova realidade do domínio.

Devido a complexidade dos relacionamentos das ontologias utilizadas, apenas as
...
as ontologias devem ser construídas e depois o \textit{plugin AccTrace} deve ser
...
\begin{itemize}
  ...
  \textit{LibreOffice}\footnote{http://pt-br.libreoffice.org/};
