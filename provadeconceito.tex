...
No Subprocesso 1 (Elicitação dos Requisitos do Sistema), observando a Tarefa (Identificar os Requisitos de Acessibilidade do Sistema) do \gls{mta} \citep{maia:10}, o
...
Partindo para o Subprocesso 2 (Análise de Requisitos do Sistema), na Tarefa (Especificar os Requisitos de Acessibilidade do Sistema) \citep{maia:10}, o especialista em
...
feita na Tarefa (Avaliar os Requisitos de Acessibilidade do Sistema) \citep{maia:10} e
...
executáveis que apropriadamente refletem o projeto do software. A Tarefa (Especificar Técnicas para Implementação da Acessibilidade da Interface e do
...
A tarefa (Codificar cada Unidade de Software de Acordo com Técnicas de
...
próximas tarefas são a Tarefa (Planejar Teste de Acessibilidade para Cada
Unidade de Software) e a Tarefa (Executar Teste de Acessibilidade de Cada
