...
\includegraphics[scale=0.5]{./images/subprocesso4.png}
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.5]{./images/samplematrix.jpg}
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.5]{./images/subprocesso5.png}
...
0 ou mais requisitos (\textit{Requirement}), e também pode conter zero ou mais
...
\textit{\gls{uml} Designer} (Modelo \gls{uml} de exemplo gerado pelo \textit{Eclipse, projeto \textit{TravelAgency}})}
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.3]{./images/acctrace.png}
\caption{Visualização da ferramenta \textit{AccTrace} na tela principal do
\textit{Eclipse}}
\label{fig:acctrace}
\end{figure}

No editor (\textit{AccTrace Editor})  é possível alterar
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.45]{./images/rightclick.png}
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.3]{./images/ontologyrelationship.png}
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.35]{./images/wcag2groups.png}
...
internos da ontologia são diferentes, dependendo do seu tipo e objetivo. 

A Figura \ref{fig:successcriterion127} mostra os elementos da ontologia
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.3]{./images/successcriterion.png}
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.3]{./images/successcriterion127.png}
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.45]{./images/matrixpart.png}
...
O comentário personalizado foi projetado de forma a não interfirir em outros
comentários da linguagem. Iniciando pelas barras duplas (//), foi definido um
identificador que tem a intenção de ser único (!ACCTRACE!), e o próprio \gls{id}
do recurso \gls{rdf} possui o caracter ``\#'', que é usado para separador entre
o recurso (arquivo a ser aberto) e o elemento a ser resgatado (no caso, a
associação criada entre o requisito e o modelo \gls{uml}). A opção de se
utilizar um comentário de linha (ao invés de comentários de bloco, usados por exemplo pela documentação \textit{JavaDoc}) decorreu do fato
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.5]{./images/acctracecomment.png}
...
quais técnicas estão referenciadas por aquele comentário. 

\begin{figure}[h]
\centering
\includegraphics[scale=0.5]{./images/commentview.png}
\caption{Explicitação do comentário selecionado}
\label{fig:commentview}
\end{figure}

A Figura \ref{fig:commentrecovery} mostra como recuperar as informações
relevantes partindo de um comentário no formato AccTrace.

\begin{figure}[h!]
\centering
\includegraphics[scale=0.3]{./images/commentrecovery.png}
...
O comentário passa por um \textit{Regex Match}, sendo decomposto em:
