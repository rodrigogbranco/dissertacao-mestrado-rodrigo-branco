...
\textbf{A ontologia é descrita no formato \gls{owl}, padrão definido pela \gls{w3c}
em 2004 \citep{owl:13}, que está na versão 1.0
mas já possui uma versão candidata à 2.0, lançada em 2012 \citep{owl2draft:13}. A
ontologia descrita estão no padrão 1.0. ESTÁ AMBIGUO, CONFUSO COM WCAG}
...
será utilizada neste trabalho, pois \textbf{EXPLICAR}
...
ferramenta \gls{case}, nos moldes descritos na seções \ref{linktocase} \textbf{LINKAR COM AS OUTRAS SEÇÕES}. A seguir
