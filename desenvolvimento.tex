...
A ferramenta de gerenciamento de requisitos alvo será o \gls{rmf}\ldots

A ferramenta de modelagem alvo será o \gls{emf}, por ser um \textit{puglin} da
\gls{ide} \textit{Eclipse} sobre a licensa \textit{Eclipse Public License v
1.0}\footnote{http://www.eclipse.org/legal/epl-v10.html}, o que permite
a verificação do código e possíveis intervenções. Os artefados são gerados no
formato \gls{xml}, se adequando assim ao padrão inicial de linguagem legível por
máquina proposto. Portanto, a ferramente \gls{case} proposta desenvolvida com o
objetivo de manipular os objetos de saída do \gls{emf}.

Dessa forma, é possível realizar o levantamento tecnológico das ferramentas
propostas:
