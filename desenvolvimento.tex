...
seguir, como já reforça o modelo \gls{mta}. O especialista em acessibilidade deve
...
o artefato para as fases de projeto e codificação.
 ...
 \gls{uml}, apesar de ser possível utilizar outros formatos para atingir o mesmo objetivo.
...
que define uma ontologia de acessibilidade na \textit{Web}. O principal objetivo do
...
A ferramenta desenvolvida neste trabalho utilizou a ontologia definida pelo projeto mencionado, explicado com mais detalhes posteriormente.
...
A Tarefa (Especificar Técnicas para Implementação da Acessibilidade da
...
A Tarefa (Codificar e documentar cada unidade de software de acordo com as
...
A Figura \ref{fig:figuramagica} mostra a abordagem escolhida que, partindo da Engenharia de Requisitos e chegando na construção do \textit{software},
proverá a rastreabilidade dos requisitos e das técnicas de implementação de acessibilidade. A próxima seção explicitará as ferramentas, técnicas e métodos envolvidos para construir a ferramenta de apoio proposta por este trabalho.
...
os diagramas fornecidos por \textit{default} não satisfizeram aos anseios de modelagem para o desenvolvimento deste trabalho, pois não contemplavam diagramas de sequência ou de 
...
\begin{itemize}
  ...
  \item O(s) desenvolvedor(es) refinam o código até que o mesmo esteja apto a
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{./images/requirementDesignerExample.png}
...
baixados em
https://github.com/ObeoNetwork/InformationSystem/tree/master/designs/requirement}, será possível utilizar as classes \textit{Java} resultantes e, principalmente, que o arquivo de saída da ferramenta \textit{Requirement Designer} possa ser lido e interpretado de forma simplificada como os objetos
...
No documento, são geradas três planilhas: Requisitos x Modelos, Requisitos
x Técnicas e Modelos x Técnicas. A planilha Requisitos x Modelos lista uma
...
corrigidos. Para as planilhas Requisitos x Técnicas e Modelos x Técnicas,
...
O modelo \textit{AccTrace} é carregado através do caminho encontrado e logo em seguida a
...
A recuperação dos comentários personalizados encerra a proposta deste trabalho. Os passos aqui descritos descrevem a construção da ferramenta, seguindo a abordagem da Figura \ref{fig:figuramagica} e detalhada na Figura \ref{fig:association}. O próximo capítulo apresentará uma prova de conceito, que utilizará o \gls{mta} e os \textit{plugins} e ferramentas aqui elencados para demonstrar a
rastreabilidade dos requisitos de acessibilidade, e sua conexão com as técnicas
