...
Dessa forma, para implementar a abordagem apresentada na Figura \textbf{X}, foi construída uma
...
O próximo capítulo apresentará uma prova de conceito, que utilizará o \gls{mta}
e os \textit{plugins} e ferramentas aqui elencados para demonstrar a
